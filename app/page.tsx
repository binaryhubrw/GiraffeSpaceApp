      ...
      try {
        ...
        if (eventsResponse.success) {
          ...
          events.forEach((event: { eventPhoto: any }, index: number) => {
            console.log(
              `Home Page - Event ${index + 1} Photo:`,
              event.eventPhoto
            );
            console.log(
              `Home Page - Event ${index + 1} Photo Type:`,
              typeof event.eventPhoto
            );
          });
      ...
      <main className="flex-1">
          ...
          <Container>
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                >
                  Empowering your organization to effortlessly create, manage{" "}
                  <br />
                  and elevate every event and venue experience.
                  <br />
                  Driving success and unforgettable moments every time.
                </p>
        ...
        <Section background="gray">
          <Container>
            ...
            <p className="text-center text-gray-600 mb-12">
              Discover a selection of our top-rated venues, ready to host your
              event. <br /> GiraffeSpace makes it easy to find the perfect
              space.
            </p>
            {loading ? (
        ...
        <Section background="blue">
          <Container>
            ...
            <p className="text-center text-gray-600 mb-12">
              Stay informed and never miss out. Discover and register for
              upcoming events <br />
              happening all around you. There’s always something exciting to
              join.
            </p>
          ...
          <Container>
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Your complete Event & Venue Management Solution{" "}
              </h2>
              <p className="max-w-2xl mx-auto text-gray-600">
                GiraffeSpace offers an end-to-end platform designed to
                streamline every stage of event & Venue management — from
                initial proposal to successful execution.
              </p>
            </div>
        ...
        <Section background="blue">
          <Container>
            ...
            <p className="text-center text-gray-600 mb-12">
              View key statistics and performance metrics across our entire
              System.
            </p>
