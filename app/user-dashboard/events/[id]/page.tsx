      ...
      >
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex flex-col gap-4 mb-4">
            <div>
              ...
              >
                <ArrowLeft className="mr-2 h-4 w-4 md:h-5 md:w-5" /> Back to
                Events
              </Link>
            ...
            <div className="flex items-center text-sm md:text-base">
              ...
              <span className="break-words">
                {event.eventVenues && event.eventVenues[0]
                  ? event.eventVenues[0].venue.venueName
                  : ""}
                ,{" "}
                {event.eventVenues && event.eventVenues[0]
                  ? event.eventVenues[0].venue.venueLocation
                  : ""}
              </span>
            </div>
        ...
        <div className="w-full bg-white rounded-lg shadow p-4 md:p-8 mb-6 md:mb-8">
          <div className="">
            ...
            <p className="text-gray-700 text-sm md:text-lg leading-relaxed whitespace-pre-line mb-4 break-words">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-6">
              ...
              {event.endTime && (
                <div>
                  <span className="font-medium">End Time:</span> {event.endTime}
                </div>
              )}
              <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
              <div>
                <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4">
                  ...
                  <p className="text-gray-700 mb-3 text-sm md:text-base break-words">
                    {event.eventVenues && event.eventVenues[0]
                      ? event.eventVenues[0].venue.description ||
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-xs md:text-sm">
                        Capacity:{" "}
                        {event.eventVenues && event.eventVenues[0]
                          ? event.eventVenues[0].venue.capacity
                          : 0}{" "}
                        people
                      </span>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs md:text-sm break-words">
                        Booking Type:{" "}
                        {event.eventVenues && event.eventVenues[0]
                          ? event.eventVenues[0].venue.bookingType
                          : "Not specified"}
                      </span>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  {event.eventVenues &&
                    event.eventVenues[0] &&
                    event.eventVenues[0].venue.googleMapsLink && (
                      <a
              ...
              <div>
                <img
                  src={
                    event.eventVenues && event.eventVenues[0]
                      ? event.eventVenues[0].venue.mainPhotoUrl
                      : "/placeholder.svg"
                  }
                  alt={
                    event.eventVenues && event.eventVenues[0]
                      ...
                      <PaginationContent className="flex flex-wrap justify-center gap-1 md:gap-2">
                        ...
                        {Array.from({ length: totalGuestPages }, (_, i) => {
                          ...
                          const isVisible =
                            ...
                            (pageNumber >= guestPage - 1 &&
                              pageNumber <= guestPage + 1);

                          if (!isVisible) {
                            if (
                              pageNumber === guestPage - 2 ||
                              pageNumber === guestPage + 2
                            ) {
                              return (
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to delete "{event.eventName}"? This action
                cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
