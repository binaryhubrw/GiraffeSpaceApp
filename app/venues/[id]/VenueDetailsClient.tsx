...
// Updated import path for VenueData, Amenity, BookingCondition, AvailabilitySlot, and Comment
import { Amenity, BookingCondition, AvailabilitySlot, VenueData, Comment } from "@/types/venue"
...
export default function VenueDetailsClient({ venue }: VenueDetailsClientProps) {
  ...
  useEffect(() => {
    setMounted(true)
    if (venue) {
      if (venue.availabilitySlots && venue.availabilitySlots.length > 0) {
        const allPossibleHours = generateTimeSlots()

        const updatedSlots = venue.availabilitySlots.map((slot: AvailabilitySlot) => {
                      ...
                      <Card className="rounded-lg shadow-sm">
                        <CardContent className="p-0">
                          <Calendar
                            ...
                            modifiersClassNames={{
                              fullyBooked: "bg-green-600 text-white cursor-not-allowed",
                              partiallyBooked: "border-2 border-orange-500 text-orange-800 bg-orange-50/50",
                            }}
